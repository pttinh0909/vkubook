...
class BrandProductController extends Controller
{
    ...
    public function save_brand_product(Request $request){
        ...
        if($get_image){
            ...
            Session::put('message','Thêm thương hiệu hay nhà sản xuất sản phẩm thành công.');
    ...
    public function unactive_brand_product($brand_product_id){
        ...
        Session::put('message','Tắt kích hoạt thương hiệu hay nhà sản xuất sản phẩm thành công.');
        return Redirect::to('manage-brand-product');
    ...
    public function active_brand_product($brand_product_id){
        ...
        Session::put('message','Bật kích hoạt thương hiệu hay nhà sản xuất sản phẩm thành công.');
        return Redirect::to('manage-brand-product');
    ...
    public function update_brand_product(Request $request,$brand_product_id){
        ...
        if($get_image){
            ...
            unlink('public/uploads/images/brand/'.$brand->brand_image);
                    ...
                    Session::put('message','Cập nhật thương hiệu hay nhà sản xuất sản phẩm thành công.');
                    return Redirect::to('manage-brand-product');
        }
    ...
    public function delete_brand_product($brand_product_id){
        ...
        Session::put('message','Xóa thương hiệu hay nhà sản xuất sản phẩm thành công.');
        return Redirect::to('manage-brand-product');
    }
