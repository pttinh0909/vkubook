...
class HomeController extends Controller
{
    public function index(Request $request){
        //SEO
        $meta_desc = "vkubookstore.com - nhà sách online chính hãng, giao hành cực nhanh, uy tín, chuyên nghiệp"; 
        $meta_keywords = "vkubookstore.com - nhà sách online chính hãng, giao hành cực nhanh, uy tín, chuyên nghiệp";
        $meta_title = "vkubookstore.com - nhà sách online chính hãng, giao hành cực nhanh, uy tín, chuyên nghiệp";
        $url_canonical = $request->url();

        $image_og = url('public/uploads/images/website/logo.jpg');
        //./SEO
    ...
    public function send_mail(){
                ...
                $data = array("name"=>"website trumpoppers.com","body"=>"Có đơn hàng mới đặt trên hệ thống. Bạn vui lòng vào hệ thống và kiểm tra đơn hàng nhé."); //body of mail.blade.php
            
                Mail::send('pages.send_mail',$data,function($message) use ($to_name,$to_email){
                    $message->to($to_email)->subject('Có đơn hàng mới từ website trumpoppers.com');//send this mail with subject
